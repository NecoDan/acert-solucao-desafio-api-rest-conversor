...
@Service
public class FactoryCalculoConversorFahrenheit implements IFactoryCalculoConversorService {

    @Override
    public boolean isAppliable(Historico historico) {
        return (Objects.nonNull(historico) && Objects.nonNull(historico.getEscalaTermometricaDestino()) && historico.getEscalaTermometricaDestino().isFahrenheit());
    }

    @Override
    public TipoCalculoConversao obterCalculoConversao(Historico historico) {
        return TipoCalculoConversao.FAHRENHEIT;
    }
}
